...
def bindSoc(sock, port):
    ...
    print("[TS1]: Server IP address is:  ", socket.gethostbyname(host))
...
def ts1():
    adict = readserver('PROJ2-DNSTS1.txt')
    print(adict)
    ...
    print("[TS1]: Got a connection request from a LS at", addr)
    ...
    while True:
        ...
        print('[TS1]: Data received from LS:: ', decodeData)
